    ...
    return (
        <div>
            <div className="upper">
                ...
                <p className="discribe">Here are a few reasons why you should choose Coinbase</p>
            </div> 
            <div className="flex_layout">
               <div className="Secure">
                    ...
                    <h2 class="StepTitle">Secure storage</h2>
                    <p className="info">We store the vast majority of the digital <br/>assets in secure offline storage.</p>
                    <a href="" class="Link1">
                        Learn how Coinbase keeps your funds safe <br/>and secure 
                ...
                <div class="Secure">
                    ...
                    <h2 class="StepTitle">Protected by insurance</h2>
                    <p className="info">Cryptocurrency stored on our servers is <br/>covered by our insurance policy.</p>
                        <a href="" class="Link1">
                ...
                <div class="Secure">
                    ...
                    <h2 class="StepTitle">Industry best practices</h2>
                    <p className="info">Coinbase supports a variety of the most<br/> popular digital currencies.</p>
                    <a href="" class="Link1">
