...
const Account = () => {
    return (
        <div className="account-sell">
           <div className="upper">
                <h2>Get started in a few minutes</h2>
                <p className="discribe">Coinbase supports a variety of the most popular digital currencies.</p>
            </div> 
               ...
               <div className="Quick-start">
                   <svg width="64" height="60" viewBox="0 0 64 60" fill="none">
                       <path d="M32 16a8 8 0 100-16 8 8 0 000 16zM32 20c-11.05 0-20 7.16-20 16v18h40V36c0-8.84-8.95-16-20-16z" fill="#56B4FC"></path>
                        ...
                        <path d="M33 42h-2v12h2V42z" fill="#fff"></path><path d="M38 49v-2H26v2h12z" fill="#fff"></path>
                    </svg>
                    <h2 class="StepTitle">Create an account</h2>
                </div>
                ...
                <div class="Quick-start">
                    ...
                    <h2 class="StepTitle">Link your bank account</h2>
                </div>
                <div class="Line-btn"></div>
                <div class="Quick-start">
                    <svg width="61" height="56" viewBox="0 0 61 56" fill="none">
                        ...
                        <path d="M16 36H0v20h16V36z" fill="#BFE9FF"></path><path d="M16 40H0v12h16V40z" fill="#1652F0"></path>
                    ...
                    <h2 class="StepTitle">Start buying &amp; selling</h2>
                </div>
            </div> 
        </div>
    )
